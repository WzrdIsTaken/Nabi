...
namespace nabi::Reflection
{
	...
	namespace Creation
	{
		...
		*/
		...
		inline bool I_XmlParserLog = false;
	...
	public:
		...
		EntityCreator(entt::registry& registery, EntityTemplateStore const&& entityTemplateStore);
		...
		void CreateEntity(EntityCreationSettings const& entityCreationSettings);
		/// <summary>
		/// Returns how many entity templates exist in m_EntityTemplateStore
		/// </summary>
		/// <returns>(See the summary)</returns>
		size_t GetEntityStoreSize() const;
	...
	private:
		...
		void ResolveEntityTemplateComponents(EntityTemplateData& entityTemplateData, EntityPropertyList const& entityOverriddenProperties);
