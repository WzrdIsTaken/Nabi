...
{
	void EntityPropertyList::AddProperty(std::string_view const component, std::string_view const propertyName, std::string_view const propertyValue)
	{
	...
	void EntityPropertyList::UpdateProperty(std::string_view const component, std::string_view const propertyName, std::string_view const propertyValue)
	{
	...
	void EntityPropertyList::RemoveProperty(std::string_view const component, std::string_view const propertyName)
	{
		PropertyComponentPair& propertyComponentPair = FindPropertyComponentPair(component, propertyName);
