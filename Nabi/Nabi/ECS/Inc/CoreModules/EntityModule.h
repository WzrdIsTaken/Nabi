...
namespace ecs::EntityModule
{
	...
	nabi::ECS::EntityGroup FindEntitiesByName(nabi::Context const& context, entt::hashed_string entityName);

	entt::entity FindFirstEntityByGroup(nabi::Context const& context, entt::hashed_string const entityGroupName);
	nabi::ECS::EntityGroup FindEntitiesByGroup(nabi::Context const& context, entt::hashed_string const entityGroupName);
